...
import com.unc0ded.shopeasy.databinding.FragmentCustomerShopsListBinding;
import com.unc0ded.shopeasy.viewmodels.CustomerMainActivityViewModel;
import com.unc0ded.shopeasy.views.adapters.VendorListAdapter;
...
public class CustomerShopsListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.swipeRefresh.setOnRefreshListener(() -> mCustomerMainActivityVM.fetchVendorList(PIN_CODE));
    }
